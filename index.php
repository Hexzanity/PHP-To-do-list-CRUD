...
<?php
    ...
    if (!isset($_GET['mode']) || $_GET['mode'] == 'view') {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<div class=filter><strong>Filter:</strong> ";
            ...
            echo "</select></div>";
            echo "  <div>
                        <button class=taskadd type='button' onclick=\"location.href='index-add.php'\">Add Task</button>
                    </div>";
            echo "</div>";
            echo "<table>";
            echo "  <tr>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                    ...
                    echo "<td>";
                        ...
                        echo "<form style='display:inline-block' action='index-delete.php' 
